      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-20">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <Card className="p-10 shadow-xl border-0 bg-gradient-to-br from-purple-50 to-pink-50 hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
